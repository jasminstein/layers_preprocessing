function cat12_seg(mprageised, out_folder)

    mkdir(out_folder)    

    matlabbatch{1}.spm.tools.cat.estwrite.data = {mprageised};
    matlabbatch{1}.spm.tools.cat.estwrite.data_wmh = {''};
    matlabbatch{1}.spm.tools.cat.estwrite.nproc = 32;
    matlabbatch{1}.spm.tools.cat.estwrite.useprior = '';
    matlabbatch{1}.spm.tools.cat.estwrite.opts.tpm = {'/software/spm/12.7771/source/tpm/TPM.nii'};
    ...
    % matlabbatch{1}.spm.tools.cat.estwrite.extopts.segmentation.WMHtpm = {'/software/spm/toolboxes/cat12/0.2577/templates_MNI152NLin2009cAsym/cat_wmh_miccai2017.nii'};
    % matlabbatch{1}.spm.tools.cat.estwrite.extopts.segmentation.BVtpm = {'/software/spm/toolboxes/cat12/0.2577/templates_MNI152NLin2009cAsym/cat_bloodvessels.nii'};
    % matlabbatch{1}.spm.tools.cat.estwrite.extopts.segmentation.SLtpm = {'/software/spm/toolboxes/cat12/0.2577/templates_MNI152NLin2009cAsym/cat_strokelesions_ATLAS303.nii'};
    % matlabbatch{1}.spm.tools.cat.estwrite.extopts.registration.regmethod.shooting.shootingtpm = {'/software/spm/toolboxes/cat12/0.2577/templates_MNI152NLin2009cAsym/Template_0_GS.nii'};
